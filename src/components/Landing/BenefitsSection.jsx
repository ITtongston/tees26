...
const BenefitsSection = ({ benefits }) => (
  <motion.div id="entrepreneurial-details" className="mb-28">
    <div className="bg-white rounded-xl shadow-md p-8 mb-12">
      <h3 className="text-3xl font-heading font-bold mb-6 text-black text-center">
        THE 2024 TEES PITCH BENEFITS
      </h3>
      <p className="text-lg font-body font-normal text-gray-700 mb-8 text-center max-w-3xl mx-auto">
      ...
      <div className="flex flex-wrap justify-center gap-5 py-12 w-full">
        {benefits.map((benefit, index) => (
          <div
            key={index}
            className="w-full md:w-[calc(33.333%-20px)] h-[400px] flex justify-center"
          >
            <BenefitCard
              icon={benefit.icon}
              title={benefit.title}
