      ...
      <div className="w-full flex flex-col items-center justify-center px-6 md:px-12">
        ...
        >
          ...
          <Link href="/tests" className="inline-block">
            <Button
              text="Explore TESTS Now"
              className="bg-gradient-to-r from-yellow-500 to-red-600 text-white hover:opacity-90 px-8 py-4 text-lg font-bold rounded-full shadow-xl transition-all duration-300"
              icon={faBookOpen}
            />
          </Link>
        </motion.div>
