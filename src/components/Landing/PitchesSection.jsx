...
const PitchesSection = () => {
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Pitch your business live to an audience spanning 61+ countries",
    },
    {
      icon: faTools,
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-black mb-6 font-montserrat text-black">
            TES 2026 Pitches
          </h2>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h4 className="text-2xl font-bold text-center mb-8 text-red-600">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://t-ventures.tongston.com/" target="_blank">
              <Button
                text="Pitch Now "
                className="bg-red-500 hover:bg-black text-white font-bold p text-lg shadow-lg"
                icon={faRocket}
              />
            </Link>
            <Link href="/tests">
              <Button
                className="bg-black hover:bg-red-500 text-white font-bold p text-lg shadow-lg"
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-red-600">
              TEES Intrapreneurial Pitches
            </h3>
            <h4 className="text-2xl font-bold mb-8 text-black">
              Be the VIP Within: Pitch Your Intrapreneurial VIP
            </h4>
            <p className="text-xl mb-8 text-gray-700">
              Are you a VIP employee? If yes - then pitch yourself
            </p>
            ...
            <p className="text-lg font-bold bg-gradient-to-r from-yellow-500 to-red-500 text-white px-6 py-3 rounded-full inline-block mb-8 shadow-lg">
              OPEN TO EMPLOYEES IN PUBLIC/PRIVATE/NON-PROFIT INSTITUTIONS ACROSS
              AFRICA
            </p>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/tests">
                  <Button
                    text="Learn More "
                    className="font-bold  bg-red-500 hover:bg-black text-white "
                    icon={faBookOpen}
                  />
                </Link>
                <Link href="#registration-section">
                  <Button
                    ...
                    className="font-bold text-white bg-black hover:bg-yellow-600 "
                  />
                </Link>
              </div>
            </div>
