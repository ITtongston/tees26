      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <div className="text-center mb-12 md:mb-16">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <p className="text-base sm:text-lg md:text-xl text-gray-700">
              <strong>Theme:</strong> Value. Influence. Profitability – Powering People, Institutions & Governments
            </p>
          ...
          >
            ...
            <div className="space-y-4 text-sm sm:text-base">
              {[
                ...
                { time: "10:10am - 11:40am", event: "TESTS Students Competition" },
                { time: "11:45am - 12:15pm", event: "Enterprise Panel" },
                { time: "12:15pm - 1:00pm", event: "TESTS Teachers Competition" },
              ].map((item, index) => (
                <div key={index} className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                  <span className="font-semibold text-yellow-600 min-w-fit">{item.time}</span>
          ...
          >
            ...
            <div className="space-y-4 text-sm sm:text-base">
              {[
                ...
                { time: "2:30pm - 4:00pm", event: "Tertiary Students Competition" },
        ...
        >
          <div className="bg-gradient-to-r from-yellow-500 to-red-500 text-white p-4 sm:p-6 md:p-8 shadow-xl max-w-4xl mx-auto rounded-lg sm:rounded-xl md:rounded-2xl">
            <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-4">Don't Miss Out!</h4>
